import { Empty, PageHead, PageTitle } from "../ui/index.ts";
...
export function ModelsPage({
  ...
  loading = false,
  ...props
}: { entries: ReadonlyArray<AgentEntry>; loading?: boolean } & AgentSectionProps) {
  return (
    <div className="agent-page">
      <PageHead lead={<PageTitle>模型</PageTitle>}>
        {loading ? <Empty description="正在读模型设置" busy art="scanning" /> : null}
